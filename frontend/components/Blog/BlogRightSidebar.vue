            ...
            <div class="col-lg-6 col-md-6">
              <div class="single-blog-post">
                <div class="blog-image">
                  ...
                  <div class="date">
                    <feather type="calendar" /> March 15, 2019
                  </div>
                </div>
                ...
                <div class="blog-post-content">
                  ...
                  <a href="#" class="read-more-btn">Read More <feather type="arrow-right" /> </a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
              <div class="single-blog-post">
                <div class="blog-image">
                  ...
                  <div class="date">
                    <feather type="calendar" /> March 17, 2019
                  </div>
                </div>
            ...
            <div class="col-lg-6 col-md-6">
              <div class="single-blog-post">
                <div class="blog-image">
                  ...
                  <div class="date">
                    <feather type="calendar" /> March 19, 2019
                  </div>
                </div>
